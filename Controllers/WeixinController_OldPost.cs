...
using YiYouLun.Weixin.MP.CommonService;
    ...
    public partial class WeixinController : Controller
    {
        ...
        public ActionResult OldPost(string signature, string timestamp, string nonce, string echostr)
        {
            ...
            try
            {
                    ...
                    case RequestMsgType.Voice://语音
                        {
                            ...
                            strongresponseMessage.Music.MusicUrl = "http://weixin.Choiskycn.com/Content/music1.mp3";
                            responseMessage = strongresponseMessage;
                            break;
                        }
                ...
                var responseDoc = YiYouLun.Weixin.MP.Helpers.EntityHelper.ConvertEntityToXml(responseMessage);
